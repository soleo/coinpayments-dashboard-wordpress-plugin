    ...
    public function display_coinpayments_dashboard_widget() {
        ...
        <div class="coinpayments-container">
            ...
            <?php foreach ($balance as $coin_name => $b) : ?>
                <li>
                    <strong><?php echo $coin_name; ?> Balance:</strong>
                    <span style="float:right;"><?php echo $b['balancef']; ?></span>
                </li>
            <?php endforeach; ?>
            </ul>
            <hr>
            <ul>
                <li>
                    ...
                    <span style="float:right;">฿ <?php echo $total_in_btc; ?></span>
                </li>
                <li>
                    <strong>Total in USD: </strong>
                    <span style="float:right;">$ <?php echo $total_in_usd; ?></span>
                </li>
            </ul>
        </div>
        <?php
